            ...
            "json_schema": {
                ...
                "schema": {
                    ...
                    "properties": {
                        ...
                        "request_details": {
                            "type": "object",
                            "description": "Complete request object matching the mock data structure",
                            "properties": {
                                ...
                                "requestor": {
                                    ...
                                    "required": ["fullName", "dateOfBirth", "ssnLast4", "email", "phone", "address", "militaryStatus", "branch", "serviceStartDate", "serviceEndDate"],
                                    "additionalProperties": False
                                },
                                "requestDetails": {
                                    "type": "object",
                                    "properties": {
                                        ...
                                        "requestedEffectiveDate": {"type": "string"}
                                    },
                                    "required": ["benefitType", "description", "requestedEffectiveDate"],
                                    "additionalProperties": False
                                },
                                "documents": {
                                    "type": "array",
                                    "items": {
                                        ...
                                        "required": ["documentId", "documentType", "fileName", "filePath"],
                                        "additionalProperties": False
                                    }
                                },
                                "customerVerification": {
                                    "type": "object",
                                    "description": "Customer verification results if available",
                                    "properties": {
                                    ...
                                    "required": ["verification_result", "confidence_percentage", "customer_id", "customer_name"],
                                    "additionalProperties": False
                                }
                            },
                            "required": ["requestId", "timestamp", "customerId", "requestor", "requestDetails", "documents", "customerVerification"],
                            "additionalProperties": False
                        },
                        "context_summary": {
                            "type": "string",
...
5. **INCLUDE FULL REQUEST DETAILS**: Always populate the `request_details` field in your structured output with complete request information
